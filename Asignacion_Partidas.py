...
def Asignacion_Partidas(usuario,puesto):
  ...
  tipo_3= placeholder14_3.selectbox("Tipo", options=("Ordinario","Producción Horas Extras","Reproceso Ordinario","Corrección de Calidad","Corrección de Calidad Extraordinaria"),key="tipo_3")
  
  placeholder15_3= st.empty()
  estado_3= placeholder15_3.selectbox("Estado" , options=("Finalizado", "En conflicto"),key="estado_3")
  
  placeholder16_3= st.empty()
  lotes_3= placeholder16_3.number_input("Cantidad Total de Puntos (Lotes)",min_value=0,key="lotes_3")
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    execute(
      ...
      """,
      params=[
        marca_3, usuario, nombre_3, puesto, supervisor_3, "Precampo", fecha_3, semana_3, año_3, distrito_3, tipo_3, lotes_3, 0, 0, horas_3, manzana_3, sector_3, 0, estado_3, 0.0, 0, 0, "P0", 0, 0, observaciones_3, "N/A", "N/A", horas_bi, area_bi, "N/A", 0, 0, "N/A", 0
      ],
    )
