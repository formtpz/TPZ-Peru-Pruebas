...
def CC_FMI(usuario,puesto):
  ...
  # ----- Bonos y Horas Extras---- #
    ...
    execute(
      ...
      """,
      params=[
        marca_3, usuario, nombre_3, puesto, supervisor_3, "Control de Calidad Folios de Matricula Inmobiliaria",
        fecha_3, semana_3, año_3, unidad_3, tipo_3, produccion_3, aprobados_3, rechazados_3, 0
      ],
    )
