...
def Postcampo_FMI(usuario,puesto):
  ...
  postcampo_fmi_3 = placeholder8_3.title("Postcampo Folios de Matricula Inmobiliaria")
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    execute(
      """
      INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas)
      VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)
      """,
      params=[
        marca_3, usuario, nombre_3, puesto, supervisor_3, "Postcampo Folios de Matricula Inmobiliaria",
        fecha_3, semana_3, año_3, unidad_3, tipo_3, produccion_3, 0, 0, 0
      ],
    )
